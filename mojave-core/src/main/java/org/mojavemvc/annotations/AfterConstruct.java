...
/**
 * <p>
 * A method annotated with this annotation will be invoked after the controller is
 * constructed. The method can take no arguments. An &#064;AfterContruct method 
 * will not be intercepted if it, or its class, is annotated with 
 ...
 * that users can perform their own activities during application initialization.
